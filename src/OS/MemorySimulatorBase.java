...
System.out.println("Process " + p.getPid() + " and Size = " + p.getSize());
...
/*
* Return the index of the first position of the next available slot in memory
...
// This is the wait functionality that we added.
...
// Initialize our main memory with the predetermined amount of reserved and free memory
